export namespace main {
	...
	export class WorksheetExportPayload {
	    content: string;
	    lastResult?: number;
	    markedLines: number[];
	...
	export class LoadWorksheetResponse {
	    ...
	    static createFrom(source: any = {}) {
	        return new LoadWorksheetResponse(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.ok = source["ok"];
	        this.error = source["error"];
	        this.payload = this.convertValues(source["payload"], WorksheetExportPayload);
	    }
	...
	export class SaveWorksheetResponse {
	    ...
	    static createFrom(source: any = {}) {
	        return new SaveWorksheetResponse(source);
	    }
