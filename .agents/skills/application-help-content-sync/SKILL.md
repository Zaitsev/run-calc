---
name: application-help-content-sync
description: Use this when you need to update and keep application help pages content synchronized between the site and in-app Help panel using site/src/content/helpContent.ts as the single source of truth.
---

# Application Help Content Sync Skill
